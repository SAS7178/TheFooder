            ...
            {isLoggedIn && (
              <div className="rightHeader" >
                <div className="rightHeaderIcons">
                  ...
                  <a href='https://www.snapchat.com/'><img alt="" className="snap__logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnxW5tD8WNeXeScnfk_D6nxjaPuEW-NVfIczYEH3KWmnw0vkkpfBG0rHZRJGzzZBebgCE&usqp=CAU" width="30" height="20"></img></a>&nbsp;&nbsp;
